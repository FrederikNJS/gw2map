...
(function() {
  ...
  tests("deepEqual", function(pass, fail) {
    ...
    fail("-0 to +0", -0, +0);
    fail("-0 to 0", -0, 0);
    fail("objects with different own properties", {id: 42}, {
      id: 42,
      di: 24
    });
    fail("objects with different own properties #2", {id: undefined}, {di: 24});
    fail("objects with different own properties #3", {id: 24}, {di: undefined});
    pass("objects with one property", {id: 42}, {id: 42});
    pass("objects with one object property", {obj: {id: 42}}, {obj: {id: 42}});
    fail("objects with one property with different values", {id: 42}, {id: 24});
    var deepObject = {
      id: 42,
      name: "Hey",
      sayIt: function() {
    ...
    pass("arguments to array like object", arrayLike, gather(1, 2, {}, []));
  });
  tests("deepEqual", function(pass, fail) {
    (function() {
      var cyclic1 = {},
    ...
    (function() {
      ...
      fail("different cyclic objects (cycle on 2nd level)", cyclic1, cyclic2);
    }());
    (function() {
      var cyclic1 = {},
          cyclic2 = {};
    ...
    (function() {
      ...
      fail("different cyclic objects (cycle on 3rd level)", cyclic1, cyclic2);
    }());
    (function() {
      var cyclic1 = {},
          cyclic2 = {};
    ...
    (function() {
      ...
      pass("referencing different but equal cyclic objects", cyclic1, cyclic2);
    }());
    (function() {
      var cyclic1 = {a: "a"},
          cyclic2 = {a: "a"};
      ...
      cyclic2.ref = {b: "b"};
      cyclic2.ref.ref = cyclic2.ref;
      fail("referencing different and unequal cyclic objects", cyclic1, cyclic2);
    }());
  });
  tests("match", function(pass, fail, shouldThrow, add) {
    pass("matching regexp", "Assertions", /[a-z]/);
    pass("generic object and test method returning true", "Assertions", {test: function() {
        return true;
      }});
    fail("non-matching regexp", "Assertions 123", /^[a-z]$/);
    pass("matching boolean", true, true);
    fail("mismatching boolean", true, false);
    fail("generic object with test method returning false", "Assertions", {test: function() {
        return false;
      }});
    ...
    pass("matcher function returns true", "Assertions 123", function(obj) {
      return true;
    });
    fail("matcher function returns false", "Assertions 123", function(obj) {
      return false;
    });
    fail("matcher function returns falsy", "Assertions 123", function() {});
    fail("matcher does not return explicit true", "Assertions 123", function() {
      return "Hey";
    });
    ...
    pass("strings ignoring case", "Look ma, case-insensitive", "LoOk Ma, CaSe-InSenSiTiVe");
    fail("match string is not substring of matchee", "Vim", "Emacs");
    fail("match string is not substring of object", {}, "Emacs");
    fail("matcher is not substring of object.toString", {toString: function() {
        return "Vim";
      }}, "Emacs");
    ...
    pass("nested matcher", object2, {owner: {
        someDude: "Yes",
    ...
    pass("dom elements with matching data attributes", {getAttribute: function(name) {
        if (name === "data-path") {
          return "foo.bar";
        }
      }}, {"data-path": "foo.bar"});
    fail("dom elements with not matching data attributes", {getAttribute: function(name) {
        if (name === "data-path") {
          return "foo.foo";
        }
      }}, {"data-path": "foo.bar"});
