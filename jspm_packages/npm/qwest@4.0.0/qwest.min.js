              ...
              n = "function" == typeof n ? n() : null === n ? "" : void 0 === n ? "" : n, e[e.length] = encodeURIComponent(t) + "=" + encodeURIComponent(n);
                ...
                n = function(e, o, r) {
                  ...
                  if ("[object Array]" === Object.prototype.toString.call(o))
                    for (s = 0, i = o.length; i > s; s++)
                      n(e + "[" + ("object" == typeof o[s] ? s : "") + "]", o[s], r);
                  else if (o && "[object Object]" === o.toString())
                    for (a in o)
                      o.hasOwnProperty(a) && (e ? n(e + "[" + a + "]", o[a], r, t) : n(a, o[a], r, t));
                  else if (e)
                    t(r, e, o);
                  else
                    for (a in o)
            ...
            return u.then = function(u, c) {
              var d = s(e),
                  f = function() {
                    ...
                    try {
                      var o = i ? u : c;
                      t(o) ? e(o.apply(r, a || [])) : d(i, a);
                    } catch (s) {
                      d(!1, [s]);
                    }
                  };
              return null != i ? o(f) : p.push(f), d;
            }, e && (u = e(u)), u;
          };
      ...
      qwest: [function(_dereq_, module, exports) {
        module.exports = function() {
          var global = window || this,
                ...
                var nativeResponseParsing = !1,
                    ...
                    promise = pinkyswear(function(e) {
                      return e.abort = function() {
                        ...
                        if (!sending) {
                          if (requests == limit)
                            return void request_stack.push(e);
                          if (++requests, sending = !0, timeout_start = (new Date).getTime(), xhr = getXHR(), crossOrigin && ("withCredentials" in xhr || !global.XDomainRequest || (xhr = new XDomainRequest, xdr = !0, "GET" != method && "POST" != method && (method = "POST"))), xdr ? xhr.open(method, url) : (xhr.open(method, url, options.async, options.user, options.password), xhr2 && options.async && (xhr.withCredentials = options.withCredentials)), !xdr)
                            for (var t in headers)
                              headers[t] && xhr.setRequestHeader(t, headers[t]);
                    ...
                    handleResponse = function() {
                      var i,
                          responseType;
                      if (--requests, sending = !1, (new Date).getTime() - timeout_start >= options.timeout)
                        return void(options.attempts && ++attempts == options.attempts ? promise(!1, [new Error("Timeout (" + url + ")"), xhr, response]) : promise.send());
              ...
              getNewPromise = function(e) {
                var t = [],
                    n = 0,
                    o = [];
                return pinkyswear(function(r) {
                  var s = function(e) {
                    return function(s, i, a, p) {
                      return ++n, t.push(qwest(e, r.base + s, i, a, p).then(function(e, t) {
                        o.push(arguments), --n || r(!0, 1 == o.length ? o[0] : [o]);
                      }, function() {
                        r(!1, arguments);
                      })), r;
                    };
                  };
                  r.get = s("GET"), r.post = s("POST"), r.put = s("PUT"), r["delete"] = s("DELETE"), r["catch"] = function(e) {
                    return r.then(null, e);
                  }, r.map = function(e, t, n, o, r) {
                    return s(e.toUpperCase()).call(this, t, n, o, r);
                  };
                  for (var i in e)
                    i in r || (r[i] = e[i]);
