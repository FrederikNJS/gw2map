  ...
  buster.testCase("formatio.ascii", {
    ...
    "limit formatted array length": {
      "should stop at given limit": function() {
        ...
        var configuredFormatio = formatio.configure({limitChildrenCount: 30});
      ...
      "should only format as many elements as exists": function() {
        ...
        configuredFormatio = formatio.configure({limitChildrenCount: 30});
        var str = configuredFormatio.ascii(array);
    ...
    "formats nested array nicely": function() {
      ...
      assert.equals(formatio.ascii(object), "{ people: [\"Chris\", \"August\"] }");
    },
    ...
    "DOM elements": {
      ...
      "truncates dom element content": function() {
        ...
        assert.equals(formatio.ascii(element), "<div>Oh hi! I'm Christian[...]</div>");
      },
