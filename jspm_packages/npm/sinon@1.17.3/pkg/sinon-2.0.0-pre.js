    ...
    (function(f) {
      ...
      return (function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
          ...
          "./sinon/util/core": 26,
          "./sinon/util/event": 33,
          "./sinon/util/fake_server": 34,
          "./sinon/util/fake_server_with_clock": 35,
          "./sinon/util/fake_timers": 36,
          "./sinon/util/fake_xdomain_request": 37,
          "./sinon/util/fake_xml_http_request": 38
        }],
        2: [function(require, module, exports) {
          ...
          "./match": 8,
          "./util/core/called-in-order": 17,
          "./util/core/format": 21,
          "./util/core/order-by-first-call": 28,
          "./util/core/times-in-words": 30
        }],
            ...
            function getCallbackError(behavior, func, args) {
              if (behavior.callArgAt < 0) {
                ...
                if (behavior.callArgProp) {
                  msg = functionName(behavior.stub) + " expected to yield to '" + behavior.callArgProp + "', but no object with such a property was passed.";
                } else {
          ...
          var mockExpectation = {
            ...
            verifyCallAllowed: function verifyCallAllowed(thisValue, args) {
              ...
              if ("expectedThis" in this && this.expectedThis !== thisValue) {
                mockExpectation.fail(this.method + " called with " + thisValue + " as thisValue, expected " + this.expectedThis);
              }
              if (!("expectedArguments" in this)) {
                return;
              }
              if (!args) {
                mockExpectation.fail(this.method + " received no arguments, expected " + format(this.expectedArguments));
              }
              if (args.length < this.expectedArguments.length) {
                mockExpectation.fail(this.method + " received too few arguments (" + format(args) + "), expected " + format(this.expectedArguments));
              }
              if (this.expectsExactArgCount && args.length !== this.expectedArguments.length) {
                mockExpectation.fail(this.method + " received too many arguments (" + format(args) + "), expected " + format(this.expectedArguments));
              }
              for (var i = 0,
                  l = this.expectedArguments.length; i < l; i += 1) {
                if (!verifyMatcher(this.expectedArguments[i], args[i])) {
                  mockExpectation.fail(this.method + " received wrong arguments " + format(args) + ", didn't match " + this.expectedArguments.toString());
                }
                if (!deepEqual(this.expectedArguments[i], args[i])) {
                  mockExpectation.fail(this.method + " received wrong arguments " + format(args) + ", expected " + format(this.expectedArguments));
                }
              }
            },
        ...
        11: [function(require, module, exports) {
          ...
          "./extend": 6,
          "./util/core": 26,
          "./util/fake_server_with_clock": 35,
          "./util/fake_timers": 36
        }],
        12: [function(require, module, exports) {
          ...
          var spyApi = {
            ...
            getCall: function getCall(i) {
              ...
              return spyCall(this, this.thisValues[i], this.args[i], this.returnValues[i], this.exceptions[i], this.callIds[i], this.stacks[i]);
            },
            getCalls: function() {
              var calls = [];
              var i;
          ...
          "./util/core/deep-equal": 19,
          "./util/core/function-name": 22,
          "./util/core/function-to-string": 23,
          "./util/core/get-property-descriptor": 25,
          "./util/core/times-in-words": 30,
          "./util/core/wrap-method": 32
        }],
        ...
        26: [function(require, module, exports) {
          ...
          "./format": 21,
          "./function-name": 22,
          "./function-to-string": 23,
          "./get-config": 24,
          "./get-property-descriptor": 25,
          "./object-keys": 27,
          "./order-by-first-call": 28,
          "./restore": 29,
          "./times-in-words": 30,
          "./walk": 31,
          "./wrap-method": 32
        ...
        36: [function(require, module, exports) {
          ...
          exports.clock = {create: function(now) {
        ...
        45: [function(require, module, exports) {
          if (typeof module !== "undefined" && module.exports) {
            this["encoding-indexes"] = require('./encoding-indexes')["encoding-indexes"];
          }
          (function(global) {
            'use strict';
            ...
            TextDecoder.prototype = {decode: function decode(input, options) {
                ...
                if (code_points.length) {
                  if (['utf-8', 'utf-16le', 'utf-16be'].indexOf(this.encoding) !== -1 && !this._ignoreBOM && !this._BOMseen) {
            ...
            function TextEncoder(encoding, options) {
              ...
              if (this._encoding === null || this._encoding.name === 'replacement')
                throw RangeError('Unknown encoding: ' + encoding);
              var allowLegacyEncoding = Boolean(options['NONSTANDARD_allowLegacyEncoding']);
            ...
            function ISO2022JPEncoder(options) {
              ...
              this.handler = function(stream, code_point) {
                ...
                if (code_point === end_of_stream && iso2022jp_state === states.ASCII)
                  return finished;
                if (iso2022jp_state === states.ASCII && inRange(code_point, 0x0000, 0x007F))
                  return code_point;
                if (iso2022jp_state === states.Roman && inRange(code_point, 0x0000, 0x007F) && code_point !== 0x005C && code_point !== 0x007E) {
                  if (inRange(code_point, 0x0000, 0x007F))
                    return code_point;
                  if (code_point === 0x00A5)
                    return 0x5C;
                ...
                if (inRange(code_point, 0x0000, 0x007F) && iso2022jp_state !== states.ASCII) {
                  stream.prepend(code_point);
            ...
            function ShiftJISDecoder(options) {
              ...
              this.handler = function(stream, bite) {
                ...
                if (shiftjis_lead !== 0x00) {
                  ...
                  if (code_point === null && pointer !== null && inRange(pointer, 8836, 10528))
